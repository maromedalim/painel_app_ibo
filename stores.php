...
<main role="main" class="col-15 pt-4 px-5">
    <div class="row justify-text-center"><div class="chartjs-size-monitor" style="position:absolute ; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;">
        ...
        <div id="main">
          ...
          <!-- Cabeçalho da Página -->
            <br>
            <h2>Painel de Revendas Premium</h2>
            <span>Os revendedores Premium podem trocar as datas de vencimentos para qualquer data que eles preferir, isso é ideal para admin do sistema.</span>
            <br>
...
while ($row = $res->fetchArray()) {
    ...
    echo "                  <td><a class=\"btn btn-icon\" href=\"./stores_update.php?update=" . $id . "\"><span class=\"icon text-white-50\"><i class=\"fa fa-pencil\" style=\"font-size:24px;color:blue\"></i></span></a></td>" . "\n";
    echo "                  <td><a class=\"btn btn-icon\" href=\"#\" data-href=\"./stores.php?delete=" . $id . "\" data-toggle=\"modal\" data-target=\"#confirm-delete\"><span class=\"icon text-white-50\"><i class=\"fa fa-trash\" style=\"font-size:24px;color:red\"></i></span></a></td>" . "\n";
    echo "\t\t\t\t</tr>\n\t\t\t</tbody>\n";
}
echo "\t\t\t</table>\n\t\t</div>\n</main>\n\n    <br><br><br>\n";
